...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `greetings_UN` (`greeting`),
    UNIQUE KEY `greetings_id_IDX` (`id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 2
...
/*!40000 ALTER TABLE `greetings`
    DISABLE KEYS */;
INSERT INTO `greetings`
VALUES (1, 'Hello World, from MariaDB!');
/*!40000 ALTER TABLE `greetings`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-06-30 14:51:58
